...
const BlockedSession = "Session is blocked"
const IncorrectSession = "Session is incorrect fot this user"
const MismatchedSessionToken = "Session tokens are mismatched"
const ExpiredSession = "Session has expired"
